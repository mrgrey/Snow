...
{
    /// <summary>
    /// Содержит флаги управления значением регистров N и Z
    /// </summary>
    [Flags]
    public enum NZRegistersValueOperationType
    {
        /// <summary>
        /// Установить Z соответственно БР
        /// </summary>
        SetZ = 1,
        /// <summary>
        /// Установить N соответственно БР
        /// </summary>
        SetN = 2,
    }
}
